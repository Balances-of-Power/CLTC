...
The use of personal data by governments is of special concern to marginalized groups of people.  Our latest modeling effort focuses on the way that modern data technologies can facilitate the disproportionate enforcement of laws against minority groups.  A major contribution of this study is a game theoretic framework that can distinguish between four different types of privacy: two that are technologically enforced, and two that are legally enforced.  We have already submitted one paper for publication to explain these efforts~\cite{johnsonprivacy}; and we hope this analysis will form a useful basis for future investigations.  %This work culminated in a paper that is currently under submission~\cite{johnsonprivacy}.

\item \textbf{Dynamic Research Focus.}  The ultimate goal of our initiative is an understanding of the ways in which personal data technologies may be used (and abused) far into the future.  Creating this outlook demands that we appreciate the process by which notions of privacy evolve over time.  While the capabilities of a technology affect the ways that governments and corporations exert power, these capabilities are mediated by social practices, laws, and countervailing technologies, all of which may change in response to privacy attitudes.  Recognizing the importance of these issues, we added a new research question that is explicitly tied to the dynamic evolution of privacy.  This question will serve as a bridge to our final goal of understanding the role of personal data, 30 years into the future.
...
By combining game theoretic modeling with experimentation, \benjamin{my team and I}I will attempt to paint a more complete picture of current trends in personal data collection.  \benjamin{Our}My final research question attempts to extrapolate these trends well into the future.  In thirty years time, what structures could govern the flow of personally identifiable data?  Will consumers maintain any privacy in the face of advancing data collection technologies?  What relationships could exist between citizens, governments, and corporations?
...
Once a model has been constructed to describe a scenario involving exchanges of personal data, we use tools from game theory to derive the model's equilibrium states, which correspond to predictions of behavior. For example, we may consider a game between a set of consumers and a set of corporations in which the corporations sell consumers' personal data to each other.  By characterizing the equilibrium of this game, we can investigate how well consumers fare in response to different governmental policies and other model parameters.

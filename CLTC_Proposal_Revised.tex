...
The use of personal data by governments is of special concern to marginalized groups of people.  Our latest modeling effort focuses on the way that modern data technologies can facilitate the disproportionate enforcement of laws against minority groups.  A major contribution of this study is a game theoretic framework that can distinguish between four different types of privacy: two that are technologically-enforced, and two that are legally-enforced.  We hope this analysis will form a useful basis for future investigations.  This work culminated in a paper that is currently under submission.
...
In a follow-up study, which was made possible by our scoping award, we turned our attention to marginalized groups within society~\cite{johnsonprivacy}.  The use of personal data is of special concern to such groups, which may find themselves disproportionately targeted by law enforcement agencies.  Personal data technologies may facilitate the identification of individuals based on their characteristics, as well as the gathering of evidence that a crime has occurred.  In our study, we defined a metric for measuring the divisiveness of a law to see whether privacy protection could lead to more equitable outcomes.  Our model distinguished between four different types of privacy protection: two that are legal and two that are technological.  Each type of protection limited certain divisive laws, though none was perfectly aligned with the goal of reducing divisiveness. 
...
\subsubsection*{Human-Subjects Experiments}

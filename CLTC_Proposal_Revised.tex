...
\item Conference papers and two or more journal articles that disseminate our findings to the academic community.
...
\item \textbf{Plans for Experimentation.} To support our dynamic research focus, we will investigate the evolution of privacy attitudes with a series of human-subject experiments.  Our design involves presenting online subjects with information regarding the use of an emerging technology, especially one that involves an abuse of power.  We seek to measure changes in attitudes towards privacy, specifically the extent to which an individual attributes responsibility for the appropriate use of personal data to users, corporations, and governments.  We expect this work to complement our game theoretic analysis, broaden our view beyond purely rational responses, and yield a more complete picture of the way personal data shapes balances of power.
...
\subsection*{Research Question 3: What factors best explain the evolution of attitudes, laws, and practices related to the exchange of personal data?}
...
Our third research question examines the factors that explain changes in the way people view privacy and the use of personal data.  We plan to investigate this question using a series of randomized, human-subject experiments, which we will conduct online.  Subjects will be divided into a number of treatment conditions and presented with information regarding the use of a privacy-related technology by their government.  A key explanatory variable is the degree to which abuses of the technology are revealed.  In one treatment condition, subjects are only told that the new technology provides access to sensitive information.  In a second treatment condition, subjects are informed of actual consequences to individuals that have their privacy compromised.  A control group is presented with unrelated information to form a baseline for analysis.  Our dependent variables are designed to capture attitudes towards privacy.  In particular, we will measure the extent to which individuals place responsibility on users, corporations, and on the legal system to regulate the use of personal data.

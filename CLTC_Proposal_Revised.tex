...
Human-subject experiments have been previously applied to the study of privacy \cite{acquisti2007can,Grossklags:WEIS07,acquisti2004privacy}.  In the context of this research program, experiments provide a way to validate relationships seen in our game-theoretic models, and to contextualize them by adding a sense of magnitude.  A further advantage of this technique is the ability to study individual preferences, even beyond those that are rational in a game-theoretic sense.  This means that we can broaden our discussion from the way citizen resist abuses of power, to the features of a practice that make it abusive.  Similarly, we may look behind a government's desire to stay in power, to the qualities of an opposition that drive adoption of a surveillance practice.  Our methodology acknowledges the fact that privacy attitudes and behavior change over time, and it examines responses to new uses of personal data.
...
Beyond the CLTC community, we hope our work will be interesting to several audiences.  One is the growing community of researchers that apply economic tools to study personal data.  In our exploratory work, we already advanced the modeling toolkit that that can be applied to this topic.  For example, we extended two-firm privacy models to allow a continuous distribution of consumers, and we created a framework that allows us to compare the effects of four distinct types of privacy protection.  We expect our work to yield more methodological advances, especially in the area of dynamic models that aim to describe how uses of personal data change over time


Policy makers represent a further audience for our work.  Our models of corporate behavior incorporate regulation as a parameter, allowing us to study the effects of limiting the use or sharing of personally identifiable data.  Government officials may be further interested in what policies may influence other regimes to become less corrupt.  In these areas, we hope to create actionable guidelines that policy makers can use to enhance the position of ordinary citizens against corporations and abusive states.
